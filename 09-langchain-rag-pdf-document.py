"""
09-langchain-rag-pdf-document.py

A Streamlit web app for Retrieval-Augmented Generation (RAG) QA over uploaded PDF or TXT documents.
Loads, splits, embeds, and retrieves from user-uploaded content using LangChain and OpenAI APIs.
"""
...
def generate_response(uploaded_file, openai_api_key, query_text):
    """
    Given an uploaded file, OpenAI API key, and user query, run a RAG QA pipeline:
